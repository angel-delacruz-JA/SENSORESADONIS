...
import { DisksList, Visibility, DriveConfig, DriverContract, DriveFileStats, LocalDriverConfig, DriveManagerContract, FakeImplementationCallback } from '@ioc:Adonis/Core/Drive';
...
export declare class DriveManager extends Manager<ApplicationContract, DriverContract, DriverContract, {
     ...
     */
    fake(disk?: keyof DisksList): FakeDrive;
    /**
